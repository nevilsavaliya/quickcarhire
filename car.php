...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            url: 'ajax/ajaxrecommendation.php',
            type: 'post',
            data: {
                button_value: <?= $totalkm8 ?>
            },
                                    ...
                                    <ul class="nav nav-tabs justify-content-center pt-3 py-2" role="tablist"
                                        ...
                                        <li class="nav-item">
                                            <button class="btn btn-outline-primary btn-lg active" data-toggle="tab"
                                                    href="#home" role="tab" value="<?= $totalkm8 ?>"
                                                    onclick="calculatePrice(<?= $totalkm8 ?>)">>
                                                <?= $totalkm8 ?> KMS
                                            </button>
                                        </li>&nbsp;
                                        <li class="nav-item">
                                            <button class="btn btn-outline-primary btn-lg" data-toggle="tab"
                                                    href="#profile" role="tab" value="<?= $totalkm15 ?>"
                                                    onclick="calculatePrice(<?= $totalkm15 ?>)">>
                                                <?= $totalkm15 ?> KMS
                                            </button>
                                        </li>&nbsp;
                                        <li class="nav-item">
                                            <button class="btn btn-outline-primary btn-lg" data-toggle="tab"
                                                    href="#messages" role="tab" value="<?= $totalkm20 ?>"
                                                    onclick="calculatePrice(<?= $totalkm20 ?>)">>
                                                <?= $totalkm20 ?> KMS
                                            </button>
                                        </li>
                                    </ul>
            ...
            <div class="wrapper">
                <section id="products">
                    <div class="container"><br/>
                        <div class="row">
                            <h1>Cars You Might Like</h1>
                            <div class="main__title" id="recommendation">
