...
//
// Description : Example 044 for pdf class
 ...
 * @abstract pdf - Example: Move, copy and delete pages
 * @author Nicola Asuni
 * @since 2009-01-02
 * @group page
 * @group pdf
...
$txt = 'pdf allows you to Copy, Move and Delete pages.';
