...
//
// Description : Example 061 for pdf class
//               XHTML + CSS
//
// Author: Nicola Asuni
//
 ...
 * @abstract pdf - Example: XHTML + CSS
 * @author Nicola Asuni
 * @since 2010-05-25
 * @group html
 * @group css
...
Since the CSS margin command is not yet implemented on pdf, you need to set the spacing of block tags using the following method.
