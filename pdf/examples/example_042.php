...
//
// Description : Example 042 for pdf class
 ...
 * @abstract pdf - Example: Test Image with alpha channel
 * @author Nicola Asuni
 * @since 2008-12-23
 * @group image
 * @group pdf
...
$background_text = str_repeat('pdf test PNG Alpha Channel ', 50);
