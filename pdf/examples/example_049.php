...
//
// Description : Example 049 for pdf class
//               WriteHTML with pdf callback functions
//
// Author: Nicola Asuni
//
// (c) Copyright:
 ...
 * @abstract pdf - Example: WriteHTML with pdf callback functions
 * @author Nicola Asuni
 * @since 2008-03-04
 * @group html
 * @group pdf
...
constant on pdf configuration file.

For security reasons, the parameters for the 'params' attribute of pdf
...
$html = '<h1>Test pdf Methods in HTML</h1>
<h2 style="color:red;">IMPORTANT:</h2>
<span style="color:red;">If you are using user-generated content, the tcpdf tag can be unsafe.<br />
You can disable this tag by setting to false the <b>K_TCPDF_CALLS_IN_HTML</b> constant on pdf configuration file.</span>
