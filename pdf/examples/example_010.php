...
//
// Description : Example 010 for pdf class
 ...
 * @abstract pdf - Example: Text on multiple columns
 * @author Nicola Asuni
 * @since 2008-03-04
 * @group column
 * @group pdf
...
/**
 * Extend pdf to work with multiple columns
 */
