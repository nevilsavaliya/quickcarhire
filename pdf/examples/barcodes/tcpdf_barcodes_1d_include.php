...
//
// Description : Search and include the pdf Barcode 1D class.
//
// Author: Nicola Asuni
//
// (c) Copyright:
...
/**
 * Search and include the pdf Barcode 1D class.
 * @package com.tecnick.tcpdf
 * @abstract pdf - Include the main class.
 * @author Nicola Asuni
 * @since 2013-05-19
 */

// Include the pdf 1D barcode class (search the class on the following directories).
