...
//
// Description : Example 059 for pdf class
 ...
 * @abstract pdf - Example: Table Of Content using HTML templates.
 * @author Nicola Asuni
 * @since 2010-05-06
 * @group toc
 * @group html
...
/**
 * pdf class extension with custom header and footer for TOC page
 */
