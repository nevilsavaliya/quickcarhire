...
/**
 * @file
 * This is a PHP class that contains static methods for the pdf class.<br>
...
class TCPDF_STATIC {
	...
	/**
	 * Return the current pdf version.
	 * @return string pdf version string
	...
	/**
	 * Return the current pdf producer.
	 * @return string pdf producer string
	 ...
	 * @param string $file_id pdf file_id.
