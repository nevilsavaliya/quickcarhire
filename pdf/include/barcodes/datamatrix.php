...
// DESCRIPTION :
//
// Class to create DataMatrix ECC 200 barcode arrays for pdf class.
...
class Datamatrix {
	...
	/**
	 * Barcode array to be returned which is readable by pdf.
	 * @protected
	 */
...
// -----------------------------------------------------------------------------
	...
	/**
	 * Returns a barcode array which is readable by pdf
	 * @return array barcode array readable by pdf;
	 * @public
	 */
