...
// -------------------------------------------------------------------
//
// Description :Font methods for pdf library.
//
//============================================================+

/**
 * @file
 * Unicode data and font methods for pdf library.
 * @author Nicola Asuni
...
class TCPDF_FONTS {
	 ...
	 * @return string|false pdf font name or boolean false in case of error.
	 * @author Nicola Asuni
	...
	public static function addTTFfont($fontfile, $fonttype='', $enc='', $flags=32, $outpath='', $platid=3, $encid=1, $addcbbox=false, $link=false) {
		...
		// font metrics
		$fmetric = array();
		// build new font name for pdf compatibility
		...
		$pfile = '<'.'?'.'php'."\n";
		$pfile .= '// pdf FONT FILE DESCRIPTION'."\n";
