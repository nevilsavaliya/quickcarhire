...
// -------------------------------------------------------------------
//
// Description : This is a command line script to generate pdf fonts.
//
//============================================================+

/**
 * @file
 * This is a command line script to generate pdf fonts.<br>
...
function showHelp() {
	$help = <<<EOD
tcpdf_addfont - command line tool to convert fonts for the pdf library.
