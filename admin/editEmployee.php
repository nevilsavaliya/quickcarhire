    ...
    <body id="page-top">
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                $query = $conn->prepare("SELECT * FROM employee where Email=?");
                    ...
                    <main>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="row">
                                    <div>
                                        <h4 class="m-0 font-weight-bold text-primary">Edit Employee</h4>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="Admin_Name" name="Admin_Name" value="<?= $Admin_name ?>" type="text" placeholder="Admin Name" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode > 31 && event.charCode < 33)" required/>
                                                <label for="Admin_Name">Employee Name</label>
                                                <span id="name"></span>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="Admin_Email_Id" name="Admin_Email_Id" value="<?= $Admin_email_id ?>" type="email" placeholder="Admin Email Id" required/>
                                                <label for="Admin_Email_Id">Employee Email Id</label>
                                                <span id="Email"></span>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="Admin_Password" name="Admin_Password" value="<?= $Admin_password ?>" type="text" placeholder="Admin Password" title="Password must be at least 8 characters and contain at least one number and one special symbol." required/>
                                            ...
                                            <div class="d-grid gap-2">
                                                <input type="submit" name="Adminsubmit" id="Adminsubmit" class="btn btn-primary btn-lg" value="Update Employee">
                                            </div>
                                        </form>
                                    </div>
                                </div>
